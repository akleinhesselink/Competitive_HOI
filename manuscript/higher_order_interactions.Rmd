...
Finally different species are likely to have different rates of resource uptake and respiration and tissue loss. We simulate a two species community with an early and late season species. 

In our simulations, we assume a trade-off between rate of resource uptake $u$ and tissue loss $m$. This results in distinct growth phenology for each species, with species with higher $u$ growing faster earlier in the season but senescing later. 
