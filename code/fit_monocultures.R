...
fit_mod1(sim_data_file = 'data/mechanistic_sim_monocultures.rds', 
         fit_file = 'data/monoculture_fit1.rds', 
         fitted_pars_file = 'data/monoculture_fit1_pars.rds')

fit_mod2(sim_data_file = 'data/mechanistic_sim_monocultures.rds', 
         fit_file = 'data/monoculture_fit2.rds', 
         fitted_pars_file = 'data/monoculture_fit2_pars.rds')
